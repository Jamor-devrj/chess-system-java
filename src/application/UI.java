...
public class UI {
	...
	public static void printBoard(ChessPiece[][] pieces) {
		...
		System.out.print(ANSI_WHITE_BACKGROUND + ANSI_BLACK + "    a b c d e f g h\n");
		System.out.println("                   ");
		System.out.println(ANSI_RESET);
	}
	...
	private static void printPiece(ChessPiece piece, boolean background) {  // para imprimir uma peça
		if(background) {
			System.out.print(ANSI_GREEN_BACKGROUND);
		}		
		if(piece == null){
			System.out.print("-" + ANSI_RESET); // "-" para definir que nao tem peça
		}
		else {
